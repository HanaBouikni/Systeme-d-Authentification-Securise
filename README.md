...
├── password.txt             # Fichier de stockage des utilisateurs (généré automatiquement)
├── README.md               # Documentation
└── requirements.txt        # Dépendances (vide - utilisation bibliothèques standard)
Classes Principales
...
Le fichier authentication_system.py contient l'implémentation complète du système avec:

Gestion des menus interactifs

Validation des entrées utilisateur

Mécanismes de hachage sécurisé
